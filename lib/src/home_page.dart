              ...
              child: SingleChildScrollView(scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
                    ...
                    Stack(children: [CircleButton('Encotrar atalhos'),
                    Padding(
                      padding: const EdgeInsets.only(left: 29,top: 50),
                      child: Container(
                        height: 20, width: 32, decoration: BoxDecoration(color: aPrimaryColor,
                        borderRadius: BorderRadius.circular(5),
                      ),
                        child:
                        Center(child: Text('Dica',
                            style: TextStyle(color: aContainerColor,fontWeight: FontWeight.w500)))
                      ),
                    )]),
                  ],
                ),
